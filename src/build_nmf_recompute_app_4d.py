...
<div class="ctrl-box">
  ...
  <div class="controls-row">
    ...
    <button id="recompute-genes-btn" title="Refit NMF using only the genes currently shown in the right biplot (gene set ∩ mean/std/metabolism filters). With no gene filter active this is all genes.">Replot with all genes</button>
...
document.getElementById('reset-btn').addEventListener('click', function() {{
  ...
  clearHeatmapOverlay();
  clearLineGraph();
  status.innerHTML = 'Reset. Hover a cell or gene to colour by expression and reveal archetype weights.';
